...
function M.highlight(palette, opts)
  return {
    ...
    ["@markup.heading.1.markdown"] = { fg = palette.blue },
    ["@markup.heading.2.markdown"] = { fg = palette.green },
    ["@markup.heading.3.markdown"] = { fg = palette.yellow },
    ["@markup.heading.4.markdown"] = { fg = palette.magenta },
    ["@markup.heading.5.markdown"] = { fg = palette.orange },
    ["@markup.heading.6.markdown"] = { fg = palette.cyan },
